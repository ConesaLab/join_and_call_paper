...
#SBATCH --output=/storage/gge/Fabian/ont_r10_sy5y/analysis/logs/pychopper_%A_%a.log
#SBATCH --error=/storage/gge/Fabian/ont_r10_sy5y/analysis/logs/pychopper_%A_%a.log
#SBATCH --ntasks=1
