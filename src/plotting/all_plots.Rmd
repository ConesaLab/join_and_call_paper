...
add_source_sheet("Fig 2",
  "Figure 2: SQANTI3 structural category of transcripts per sample, tool and combination strategy (brain).",
  .sd_bind(all_results, function(res) .sd_panel_data(res$brain_plots)))
add_source_sheet("Supplementary Fig 2",
  "Supplementary Fig. 2: SQANTI3 structural category of transcripts (kidney).",
  .sd_bind(all_results, function(res) .sd_panel_data(res$kidney_plots)))

add_source_sheet("Supplementary Fig 3",
  "Supplementary Fig. 3: Transcripts per structural category across read-support filters (brain).",
  .sd_bind(all_results, function(res) .sd_panel_data(res$brain_expression_plot)))
add_source_sheet("Supplementary Fig 5",
  "Supplementary Fig. 5: Transcripts per structural category across read-support filters (kidney).",
  .sd_bind(all_results, function(res) .sd_panel_data(res$kidney_expression_plot)))

add_source_sheet("Fig 5",
  "Figure 5: Unique junction chain (UJC) presence/absence across samples and strategies (brain).",
  .sd_bind(all_results, function(res) res$brain_upset_data))
add_source_sheet("Supplementary Fig 6",
  "Supplementary Fig. 6: UJC presence/absence membership matrix (kidney).",
  .sd_bind(all_results, function(res) res$kidney_upset_data))
