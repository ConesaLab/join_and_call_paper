...
paper_ggsave(file.path(out_dir, "brain_upset_filter1.pdf"), plot = brain_upset_plot, size = "mouse_upset")
...
paper_ggsave(file.path(out_dir, "kidney_upset_filter1.pdf"), plot = kidney_upset_plot, size = "mouse_upset")
