...
#     theme(legend.position = "none")
  ...
  if (!show_x_labels) {
    ...
    p2 <- p2 + theme(axis.text.x = paper_axis_text_x())
  }
  ...
  if (!show_x_labels) {
    ...
    p3 <- p3 + theme(axis.text.x = paper_axis_text_x())
  }
...
brain_ranking_grid
paper_ggsave(file.path(out_dir, "brain_ranking_grid.pdf"), plot = brain_ranking_grid, size = "mouse_10panel")
...
kidney_ranking_grid
paper_ggsave(file.path(out_dir, "kidney_ranking_grid.pdf"), plot = kidney_ranking_grid, size = "mouse_10panel")
