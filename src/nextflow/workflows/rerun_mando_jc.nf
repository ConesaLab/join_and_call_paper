...
params.metadata_ind = ""
params.metadata_concat = ""
params.metadata_tama_condition = ""
...
workflow {
    ...
    tama_full_output = tama_full(params.metadata_ind, params.metadata_concat, wd, joblog)

    merge_counts_output = merge_counts(params.metadata_ind, params.metadata_concat, params.metadata_tama_condition, tama_full_output.metadata_tama_full, wd, joblog)
